            ...
            try:
                with open(file_path, 'r', encoding='utf-8') as f:
                    ...
                    for line in f:
                        ...
                        if line.startswith("Valid: FALSE") or line.startswith("Valid: None"):
                            valid_block = True
                        # End of the current block
                        elif line.startswith("Valid:"):
                            valid_block = False
                        # Only capture errors within a valid block
                        elif valid_block and line.startswith("✗"):
...
def main():
    output_file='unique_invalid_upload_blocks.txt'
    directory = 'data/upload_logs/failed_uploads/'
